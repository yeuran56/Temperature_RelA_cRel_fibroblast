function [t,x, simdata, x_end] = temp_high_nfkbSimulate(stimulus, names, params_mod, init_mod, options)
...
[v.PARAMS, v.SPECIES] = temp_high_nfkbInitialize();
